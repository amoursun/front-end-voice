import { IThemeEnum } from '../store/type';
import * as monaco from 'monaco-editor';

export const config: {
  // 默认主题
  defaultThemes: IThemeEnum[];
  // 默认主题
  defaultTheme: IThemeEnum;
  // 默认语言
  ...
  defaultThemes: [IThemeEnum.VS_DARK, IThemeEnum.LIGHT],
  defaultTheme: IThemeEnum.VS_DARK,
